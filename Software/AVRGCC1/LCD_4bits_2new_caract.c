...
const unsigned char carac2[] PROGMEM = {0b00100,//Delta
 ...
 const unsigned char carac3[] PROGMEM = {0b11111,//Delta
                         				0b00100,
                         				0b00100,
                         				0b00100,
                         				0b00100,
...
{	
    ...
    for(k=0;k<7;k++)
      	cmd_LCD(pgm_read_byte(&carac3[k]),1);	//grava 8 bytes na DDRAM começando no end. 0x48 
   	cmd_LCD(0x00,1);				//apaga última posição do end. da CGRAM para evitar algum dado espúrio
	...
	cmd_LCD(0x80,0);				//endereça a posição para escrita dos caracteres
 	...
 	cmd_LCD(0xF6,1);				//apresenta segundo  caractere 0x01 	   
